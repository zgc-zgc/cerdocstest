<!DOCTYPE html><html class="writer-html5" lang="en" data-content_root="../../"><head>
  ...
  <title>Tracking changes with ghosts and hooks — Certora Prover Documentation 0.0 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="Specification Design Patterns" href="patterns/index.html">
    <link rel="prev" title="Parametric rules" href="parametric.html"> 
</head>
...
<li class="toctree-l2 current" aria-expanded="true"><a class="reference internal current" href="#" aria-expanded="true">Tracking changes with ghosts and hooks</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../../genindex.html">Index</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">Tracking changes with ghosts and hooks</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../../_sources/docs/user-guide/ghosts.md.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr>
</div>
  ...
  <section id="tracking-changes-with-ghosts-and-hooks">
<span id="tracking-changes"></span><h1>Tracking changes with ghosts and hooks<a class="headerlink" href="#tracking-changes-with-ghosts-and-hooks" title="Link to this heading"></a></h1>
...
total supply.</p>
<p><a class="reference internal" href="../cvl/ghosts.html#ghost-variables"><span class="std std-ref">Ghosts</span></a> and <a class="reference internal" href="../cvl/hooks.html#hooks"><span class="std std-ref">hooks</span></a> are designed for this
...
execution.</p>
        ...
        <a href="parametric.html" class="btn btn-neutral float-left" title="Parametric rules" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="patterns/index.html" class="btn btn-neutral float-right" title="Specification Design Patterns" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
