...
<span id="lesson4-invariants-auction"></span><h1><span class="section-number">4.2. </span>Basic exercises<a class="headerlink" href="#basic-exercises" title="Link to this heading">¶</a></h1>
<section id="erc20">
<h2>ERC20<a class="headerlink" href="#erc20" title="Link to this heading">¶</a></h2>
<p><a class="reference external" href="https://github.com/Certora/tutorials-code/blob/master/lesson4_invariants/erc20/ERC20.sol">ERC20.sol</a> contains an ERC20 implementation.
Write an invariant for ERC20 verifying that <code class="code highlight solidity docutils literal highlight-solidity"><span class="kt">address</span><span class="p">(</span><span class="m m-Decimal">0</span><span class="p">)</span></code> always has zero
balance.
Run the invariant on <a class="reference external" href="https://github.com/Certora/tutorials-code/blob/master/lesson4_invariants/erc20/ERC20.sol">ERC20.sol</a>
and discover the violation in the contract.</p>
<div class="admonition important">
<p class="admonition-title">Important</p>
<p>Remember to use the <code class="docutils literal notranslate"><span class="pre">optimistic_loop</span></code> option, see <a class="reference internal" href="../../lesson3_violations/erc20_bugs.html#optimistic-loop-in-erc20"><span class="std std-ref">Important: Optimistic loop</span></a>.</p>
</div>
<section id="hints">
...
<span class="sd-summary-text">CVL types</span><span class="sd-summary-state-marker sd-summary-chevron-right"><svg version="1.1" width="1.5em" height="1.5em" class="sd-octicon sd-octicon-chevron-right" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.72 18.78a.75.75 0 0 1 0-1.06L14.44 12 8.72 6.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l6.25 6.25a.75.75 0 0 1 0 1.06l-6.25 6.25a.75.75 0 0 1-1.06 0Z"></path></svg></span></summary><div class="sd-summary-content sd-card-body docutils">
<p class="sd-card-text">You can use <code class="code highlight cvl docutils literal highlight-cvl">balanceOf<span class="p">(</span><span class="m m-Decimal">0</span><span class="p">)</span></code> in CVL without casting it to <code class="code highlight cvl docutils literal highlight-cvl"><span class="kt">address</span></code>.</p>
</div>
...
<p class="sd-card-text">A solution is available in
<a class="reference external" href="https://github.com/Certora/tutorials-code/blob/master/solutions/lesson4_invariants/erc20/zero.spec">zero.spec</a>.</p>
</div>
</details></section>
</section>
...
<p class="sd-card-text">You will need to define the getters as <code class="code highlight cvl docutils literal highlight-cvl"><span class="kr">envfree</span></code>.</p>
</div>
</details><details class="sd-sphinx-override sd-dropdown sd-card sd-mb-3 sd-fade-in-slide-down">
<summary class="sd-summary-title sd-card-header">
<span class="sd-summary-text">Highest bidder hint</span><span class="sd-summary-state-marker sd-summary-chevron-right"><svg version="1.1" width="1.5em" height="1.5em" class="sd-octicon sd-octicon-chevron-right" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.72 18.78a.75.75 0 0 1 0-1.06L14.44 12 8.72 6.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l6.25 6.25a.75.75 0 0 1 0 1.06l-6.25 6.25a.75.75 0 0 1-1.06 0Z"></path></svg></span></summary><div class="sd-summary-content sd-card-body docutils">
<p class="sd-card-text">What is the initial value of the highest bidder?</p>
</div>
</details><details class="sd-sphinx-override sd-dropdown sd-card sd-mb-3 sd-fade-in-slide-down">
<summary class="sd-summary-title sd-card-header">
<span class="sd-summary-text">Solution</span><span class="sd-summary-state-marker sd-summary-chevron-right"><svg version="1.1" width="1.5em" height="1.5em" class="sd-octicon sd-octicon-chevron-right" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.72 18.78a.75.75 0 0 1 0-1.06L14.44 12 8.72 6.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l6.25 6.25a.75.75 0 0 1 0 1.06l-6.25 6.25a.75.75 0 0 1-1.06 0Z"></path></svg></span></summary><div class="sd-summary-content sd-card-body docutils">
<p class="sd-card-text">A full solution is available in
<a class="reference external" href="https://github.com/Certora/tutorials-code/blob/master/solutions/lesson4_invariants/auction/EnglishAuction.spec">EnglishAuction.spec</a>.</p>
</div>
</details></section>
</section>
</section>
