...
[Certora Prover Documentation](https://docs.certora.com/en/latest/index.html)
  ...
  * [Checking Specifications](https://docs.certora.com/en/latest/docs/prover/checking/index.html)
  * Bug Injection
  * [ View page source](https://docs.certora.com/en/latest/_sources/docs/prover/checking/injection.md.txt)


# Bug Injection[](https://docs.certora.com/en/latest/docs/prover/checking/injection.html#bug-injection "Link to this heading")
...
[ Previous](https://docs.certora.com/en/latest/docs/prover/checking/coverage-info.html "Coverage Info") [Next ](https://docs.certora.com/en/latest/docs/prover/checking/mutation.html "Mutation Testing")
