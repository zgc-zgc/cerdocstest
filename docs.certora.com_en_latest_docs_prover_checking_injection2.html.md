<!DOCTYPE html><html class="writer-html5" lang="en" data-content_root="../../../"><head>
  ...
  <title>Bug Injection — Certora Prover Documentation 0.0 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="Mutation Testing" href="mutation.html">
    <link rel="prev" title="Coverage Info" href="coverage-info.html"> 
</head>
...
<li class="toctree-l3 current" aria-expanded="true"><a class="reference internal current" href="#" aria-expanded="true">Bug Injection</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../../../genindex.html">Index</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">Bug Injection</li>
      <li class="wy-breadcrumbs-aside">
            <a href="../../../_sources/docs/prover/checking/injection.md.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr>
</div>
...
<h1>Bug Injection<a class="headerlink" href="#bug-injection" title="Link to this heading"></a></h1>
<p>One useful way to check specifications is by injecting bugs into the verified
contracts and checking that the Prover finds the injected bugs.</p>
</section>
        ...
        <a href="coverage-info.html" class="btn btn-neutral float-left" title="Coverage Info" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="mutation.html" class="btn btn-neutral float-right" title="Mutation Testing" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
