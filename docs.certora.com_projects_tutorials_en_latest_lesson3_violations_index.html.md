...
[Skip to content](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/index.html#furo-main-content)
...
[ Back to top ](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/index.html)
Toggle Light / Dark / Auto color theme
Toggle table of contents sidebar
# 3. Understanding violations[¶](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/index.html#understanding-violations "Link to this heading")
...
After each example are hints in case you get stuck. The lesson is concluded with a reward challenge.
  1. [Fixing ERC20 spec](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/erc20_bugs.html#lesson3-violations-erc20-bugs) - focuses on mistakes in specs for [ERC20](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/)
  2. [Borda count election](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/borda_bugs.html#lesson3-violations-borda-bugs) - focuses on bugs in Solidity code for an election
  3. [Reward Challenge : Missing Spec bounty](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/reward_challenge.html#lesson3-violations-reward-challenge) - a reward challenge


[ Next 3.1. Fixing ERC20 spec ](https://docs.certora.com/projects/tutorials/en/latest/lesson3_violations/erc20_bugs.html) [ Previous 2.7. Vacuity ](https://docs.certora.com/projects/tutorials/en/latest/lesson2_started/vacuity.html)
