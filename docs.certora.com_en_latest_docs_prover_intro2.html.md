<!DOCTYPE html><html class="writer-html5" lang="en" data-content_root="../../"><head>
  ...
  <title>Introduction — Certora Prover Documentation 0.0 documentation</title>
  ...
  <![endif]-->
    ...
    <link rel="next" title="Prover Approximations" href="approx/index.html">
    <link rel="prev" title="The Certora Prover" href="index.html"> 
</head>
...
<li class="toctree-l2 current" aria-expanded="true"><a class="reference internal current" href="#" aria-expanded="true">Introduction</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../../genindex.html">Index</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../_sources/docs/prover/intro.md.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr>
</div>
...
<p>This Reference Manual contains detailed and comprehensive information about the
Certora Prover.  The Reference Manual is intended to describe what the Prover
does, in contrast to the <a class="reference internal" href="../user-guide/index.html"><span class="doc">Certora User’s Guide</span></a> which explains how to
use the Prover to accomplish particular goals.</p>
</section>
        ...
        <a href="index.html" class="btn btn-neutral float-left" title="The Certora Prover" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="approx/index.html" class="btn btn-neutral float-right" title="Prover Approximations" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
