...
<p><span class="highlighted">CVL2</span> also supports casting from the <code class="docutils literal notranslate"><span class="pre">bytes32</span></code> type to the <code class="docutils literal notranslate"><span class="pre">address</span></code> type
