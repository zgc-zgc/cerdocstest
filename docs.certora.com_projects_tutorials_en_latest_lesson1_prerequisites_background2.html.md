...
<span id="sec-background"></span><h1><span class="section-number">1.1. </span>Background<a class="headerlink" href="#background" title="Link to this heading">¶</a></h1>
<p>Watch the following lecture by Certora’s CEO Prof. Mooly Sagiv:
<a class="reference external" href="https://youtu.be/VGSsPIsbb6U">Auditing and Formal Verification - Better together</a></p>
<blockquote>
<div><div class="video_wrapper align-center" style="text-align: center">
<iframe allowfullscreen="true" src="https://www.youtube.com/embed/VGSsPIsbb6U" style="border: 0; height: 345px; width: 560px">
      ...
      <footer>
        ...
        <div class="related-pages">
          <a class="next-page" href="propositional_logic.html">
              <div class="page-info">
                <div class="context">
                  <span>Next</span>
                </div>
