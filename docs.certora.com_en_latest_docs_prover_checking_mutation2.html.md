...
<li class="toctree-l3 current" aria-expanded="true"><a class="reference internal current" href="#" aria-expanded="true">Mutation Testing</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../../../genindex.html">Index</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">Mutation Testing</li>
...
<h1>Mutation Testing<a class="headerlink" href="#mutation-testing" title="Link to this heading"></a></h1>
<p>Mutation testing refers to changing the verified code in a way that is likely
to cause a bug, and then checking that the modified code does not pass
verification.
Learn more about how Certora uses mutation testing <a class="reference internal" href="../../gambit/index.html#gambit-intro"><span class="std std-ref">here</span></a>.</p>
</section>
